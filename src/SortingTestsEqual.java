...
/**
 * The data only includes equal elements.
 *
 * @author Tilda Jansson
 * @version  2021-03-17
 */

class SortingTestsEqual {
    public static void main(String[] args) {
        ...
        Data[] tests = {
            ...
            new Data(250, 1, Data.Order.RANDOM),
            new Data(500, 1, Data.Order.RANDOM),
            new Data(1000, 1, Data.Order.RANDOM),
            new Data(2000, 1, Data.Order.RANDOM),
            new Data(4000, 1, Data.Order.RANDOM),
            new Data(8000, 1, Data.Order.RANDOM),
            new Data(16000, 1, Data.Order.RANDOM),
            new Data(32000, 1, Data.Order.RANDOM),
        };
